...
declare type Resolution = 1 | 1.3 | 1.5 | 2 | 2.6 | 3 | 3.5 | 4;
declare type Loading = 'eager' | 'lazy';
/**
 * Image is used for large format, responsive images. For small images use Thumbnail.
 */
export declare const Image: import("@remote-ui/types").RemoteComponentType<"Image", ImageProps, true>;
export {};
