...
/** Indicate the text has been deleted. Typically used for discounted prices. */
 | 'deletion' | AbbreviationRoleType | DirectionalOverrideRoleType | DatetimeRoleType;
/**
 ...
 * content.
 */
export declare const Text: import("@remote-ui/types").RemoteComponentType<"Text", TextProps, true>;
export {};
